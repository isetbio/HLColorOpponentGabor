function visualizeSceneOrOpticalImageSequence(sceneOrOpticalImage, sceneOrOpticalImageSequence,timeAxis,  movieFileName)
% visualizeSceneOrOpticalImageSequence(sceneOrOpticalImage, sceneOrOpticalImageSequence, movieFileName)
%
...
%
    ...
    hFig = figure(10); clf;
    set(hFig, 'Position', [10 10 950 475], 'Color', [1 1 1]);
    colormap(hot(1024));
    ...
    % Determine ranges
    rgbRange = [0 1]; % [min(rgbImageSequence(:)) max(rgbImageSequence(:))]
